...
draft = false
tags = ['htb', 'writeup']
summary = 'Easy CTF box writeup from HTB season 5 machine 12'
thumbnail = 'img/px-logo.png'
+++

[PermX](https://app.hackthebox.com/machines/613) is an easy Linux CTF box, that is a part of HackTheBox season 5 machines. It requires us to bruteforce virtual hosts, perform version enumeration & exploit a known vulnerability. For the privilege escalation it requires basic Bash & Linux knowledge. Machine is created by [mtzsec](https://app.hackthebox.com/users/1573153) `+respict`.
