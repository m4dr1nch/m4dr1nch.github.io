...
draft = false 
tags = ['htb', 'writeup']
summary = 'Easy CTF box writeup from HTB season 5 machine 9'
thumbnail = 'img/ed-logo.png'
+++

[Editorial](https://app.hackthebox.com/machines/608) is an easy Linux CTF box, that is a part of the HackTheBox season 5 machines. It requires basic web vulnerability, git, and Linux privilege escalation knowledge. Machine created by [Lanz](https://app.hackthebox.com/users/73707) `+respict`.
...
Looking at the diff's for the `b73481bb823d2dfb49c44f4c1e6a7e11912ed8ae` via `git show`, a production users credentials are revealed:
...
Performing basic enumeration for root exploit we find privileges under `sudo -l`, that allow us to run a Python script as root with arbitrary parameter:
